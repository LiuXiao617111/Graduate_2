...
namespace MvcGraduate.Models
{
	...
	public partial class Notify : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Notify_Grade> _Notify_Grade;
    ...
    partial void OnAppendixChanged();
		...
		{
			this._Notify_People = new EntitySet<Notify_People>(new Action<Notify_People>(this.attach_Notify_People), new Action<Notify_People>(this.detach_Notify_People));
			this._Notify_Grade = default(EntityRef<Notify_Grade>);
			this._Students = default(EntityRef<Students>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Notify_Notify_Grade", Storage="_Notify_Grade", ThisKey="ID", OtherKey="ID", IsUnique=true, IsForeignKey=false)]
		public Notify_Grade Notify_Grade
		{
			get
			{
				return this._Notify_Grade.Entity;
			}
			set
			{
				Notify_Grade previousValue = this._Notify_Grade.Entity;
				if (((previousValue != value) 
							|| (this._Notify_Grade.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Notify_Grade.Entity = null;
						previousValue.Notify = null;
					}
					this._Notify_Grade.Entity = value;
					if ((value != null))
					{
						value.Notify = this;
					}
					this.SendPropertyChanged("Notify_Grade");
				}
			}
		}
    ...
    partial void OnNotifyGradeIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Notify_Notify_Grade", Storage="_Notify", ThisKey="ID", OtherKey="ID", IsForeignKey=true)]
		public Notify Notify
		{
			get
			{
			...
			set
			{
							...
							|| (this._Notify.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Notify.Entity = null;
						previousValue.Notify_Grade = null;
					}
					this._Notify.Entity = value;
					if ((value != null))
					{
						value.Notify_Grade = this;
						this._ID = value.ID;
					}
					else
					{
